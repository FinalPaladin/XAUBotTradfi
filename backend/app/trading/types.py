...
class PositionAction(str, Enum):
    ...
    CLOSE_DCA_LAYER_TP = "CLOSE_DCA_LAYER_TP"
...
class BasketAction(str, Enum):
    ...
    HOLD = "HOLD"
    CLOSE_TREND_FLIP = "CLOSE_TREND_FLIP"
    CLOSE_M5_REVERSAL = "CLOSE_M5_REVERSAL"
    CLOSE_MAX_USD_LOSS = "CLOSE_MAX_USD_LOSS"
    CLOSE_MAX_PCT_LOSS = "CLOSE_MAX_PCT_LOSS"
    CLOSE_DCA_FULL_STACK_LOSS = "CLOSE_DCA_FULL_STACK_LOSS"
    CLOSE_ATR_STOP = "CLOSE_ATR_STOP"
    CLOSE_TIME_STOP = "CLOSE_TIME_STOP"
    CLOSE_BASKET_TP = "CLOSE_BASKET_TP"
    CLOSE_SINGLE_SCALP = "CLOSE_SINGLE_SCALP"
    CLOSE_HARD_STOP = "CLOSE_HARD_STOP"
    CLOSE_MAX_AGE = "CLOSE_MAX_AGE"
    CLOSE_BASKET_TRAIL = "CLOSE_BASKET_TRAIL"
    CLOSE_PANIC_SIGNAL = "CLOSE_PANIC_SIGNAL"
    ADD_LAYER = "ADD_LAYER"
